...
def train_shadow_model(PATH, device, shadow_model, train_loader, test_loader, loss, optimizer):
    model = shadow(train_loader, test_loader, shadow_model, device, loss, optimizer)
    acc_train = 0
    acc_test = 0
